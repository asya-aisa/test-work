    ...
    render() {
        return (
            <div>
                ...
                /> */}
                <FioSuggestions inputProps={pattern} containerClassName='test' token="42e33f4ee0c3245f46680e43a28d80f5396bd266" value={this.state.valueFio} onChange={(e) => this.onChangeEvent(e)} />;
