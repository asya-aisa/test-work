    ...
    render() {
        return (
            <div>
                ...
                onChange={(e) => {this.onChangeEvent({value: e.target.value})}} />
                <FioSuggestions token="42e33f4ee0c3245f46680e43a28d80f5396bd266" value={this.state.value} onChange={(e) => {this.setState({value: e.target.value})}} />;
