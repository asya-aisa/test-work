...
export class InfoPartOne extends Component {
    ...
    onChangeEventBirthday(e) {
        ...
        if(userDate > date18ago) {
            ...
            this.setState({birthdayInfo: !this.state.birthdayInfo})
        }
    }
    ...
    checkState(birthday) {
        if(this.state.birthdayInfo?) {
            alert('не все поля заполнены')
        }
        {this.state.birthdayInfo? console.log(this.state.inputBirthday) : 'Не все поля заполнены'}
    }
